...
\titlerunning{Determinism of ledger updates} %TODO optional, please use if title is longer than one line
...
\authorrunning{P.  Vinogradova and J.	Chapman and A.	Knispel and O.	Melkonian}
 %TODO mandatory. First: Use abbreviated first/middle names. Second (only in severe cases): Use first author plus 'et al.'

\Copyright{Polina Vinogradova and James	Chapman and Andre	Knispel and Orestis	Melkonian}
%TODO mandatory, please use full first names. LIPIcs license is "CC-BY";  http://creativecommons.org/licenses/by/3.0/

% Hide copyright information, since this is an extended abstract.
\hideLIPIcs{}
...
\funding{This work was supported by Input Output (iohk.io) through their funding of the Edinburgh Blockchain Technology Lab.}
...
\bibliography{abstract-ledgers-paper}
